  ...
  const announcements = [
    {
      ...
      content: "The welcome speech has been moved 30 minutes earlier. Please plan accordingly.",
      date: "2025-06-05",
      isImportant: true
    },
    {
      ...
      content: "Complimentary parking is available at the venue. Please show your ticket at the entrance.",
      date: "2025-06-04",
      isImportant: false
    },
    {
      ...
      content: "The event has a semi-formal dress code. We look forward to seeing you in your best attire!",
      date: "2025-06-03",
      isImportant: false
    }
  ];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => router.push('/users/create-event')}
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-2/3">
              ...
              <div className="space-y-4">
                ...
                <button
                  className={`${selectedTheme.colors[0]} text-white px-6 py-3 rounded-md font-medium hover:opacity-90 transition-opacity flex items-center`}
                >
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    {isRegistrationOpen() 
                      ...
                      : `Opens on ${formatDate(registration.registrationOpen)}`}
                  </p>
                </div>
                    ...
                    <div className={`${selectedTheme.colors[0]} p-4 text-white`}>
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          <div className="text-xs opacity-80">Order #{(Math.random() * 1000000).toFixed(0).padStart(6, '0')}</div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="border-t border-gray-200 pt-4">
                        ...
                        <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                          userRegistration.checkInStatus 
                            ? 'bg-green-100 text-green-800' 
                            : 'bg-yellow-100 text-yellow-800'
                        }`}>
                          <span className={`w-2 h-2 rounded-full mr-2 ${
                            userRegistration.checkInStatus ? 'bg-green-500' : 'bg-yellow-500'
                          }`}></span>
